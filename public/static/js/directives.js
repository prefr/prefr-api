...
angular.module('prefrDirectives', [])
...
.directive('apiIndicator',[

	'$timeout',
	'api',

	function($timeout, api){
		return  {
			restrict:       'AE',
			scope:          true,
			templateUrl:    'static/partials/api_indicator.html',
			...
			link:           function(scope, element){
								...
								scope.$watch(function(){
									...
									if(scope.active && api.busyCalls == 0){										
										$timeout(function(){
											element.toggleClass('active', api.busyCalls > 0)	
										}, 1000)
									}
									scope.active = api.busyCalls > 0									
								})
							}
